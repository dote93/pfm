...
//        dungeon.jPanel1.setLayout(new GridBagLayout()); 
    ...
    /**
     * dungeon method is called from within the constructor to initialize the form.
     * WARNING: Do NOT modify dungeon code. The content of dungeon method is always
        ...
        try {
            ...
            if (evoMapsGenerator.evolucion) {
                ...
                String text = java.text.MessageFormat.format(""
                        + "Numero de monstruos recorrido esperados   : {0} \n"
                        + "Numero de tesoros recorrido esperados     : {1} \n"
                        + "Numero de monstruos esperados             : {2} \n"
                        + "Numero de tesoros esperados               : {3} \n"
                        + "Area Segura monstruo esperada             : {4} \n"
                        + "Area Segura tesoro esperada               : {5} \n"
                        + "Seguridad tesoro esperada                 : {6} \n"
                        + "Numero de celdas Pared esperadas          : {7} \n"
                        + "Numero de celdas Libres esperadas         : {8} \n", 
                        evoMapsGenerator.dificultad_nivel[0], 
                        evoMapsGenerator.dificultad_nivel[1],
                        evoMapsGenerator.dificultad_nivel[2], 
                        evoMapsGenerator.dificultad_nivel[3], 
                        evoMapsGenerator.dificultad_nivel[4], 
                        evoMapsGenerator.dificultad_nivel[5], evoMapsGenerator.dificultad_nivel[6], evoMapsGenerator.dificultad_nivel[7],
                        (evoMapsGenerator.porcentaje - evoMapsGenerator.numero_monstruos - evoMapsGenerator.numero_tesoros));
...
//                this.jTextPane1.getStyel
            ...
            else
            {
                ...
                String text = String.format("Numero de monstruos recorrido "
                        + "esperados   : {0} \n "
                        + "Numero de tesoros recorrido esperados     : {1} \n "
                        + "Numero de monstruos esperados             : {2} \n"
                        + "Numero de tesoros esperados               : {3} \n"
...
//            scrollPane.setBounds(50, 30, 300, 50);
    ...
    /***
     * Crea un para con las imagenes correspondientes para luego añadirlo al scrollPanel
